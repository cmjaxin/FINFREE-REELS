    ...
    <div>
      <div className="mb-8 flex items-end justify-between">
        <div>
          ...
          <h2 className="text-page-title text-neo-ink mb-2">Branding & end card</h2>
        </div>
      ...
      <div className="grid grid-cols-[392px_1fr] gap-8">
        ...
        <div className="space-y-6">
          {/* Logo */}
          <div className="bg-white rounded-lg border border-neo-border-dashed border-dashed p-6 text-center">
            <p className="font-mono text-sm text-neo-body-muted mb-2">DROP NEO LOGO</p>
            <p className="font-mono text-xs text-neo-faint">SVG OR PNG · TRANSPARENT · MIN 600PX WIDE</p>
          </div>

          {/* Palette */}
          <div className="bg-white rounded-lg border border-neo-border p-6">
            <h3 className="text-sm font-semibold text-neo-ink mb-4">Palette</h3>
            <div className="space-y-3">
              {[
                ...
                <div key={swatch.name} className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded border border-neo-border" style={{ backgroundColor: swatch.color }} />
                  <div className="flex-1">
                    <p className="text-sm text-neo-body">{swatch.name}</p>
          ...
          <div className="bg-white rounded-lg border border-neo-border p-6">
            <div className="flex items-center justify-between mb-3">
              <p className="text-sm font-medium text-neo-body">End card hold</p>
        ...
        <div className="space-y-6">
          {/* Template Selection */}
          <div className="bg-white rounded-lg border border-neo-border p-6">
            <h3 className="text-sm font-semibold text-neo-ink mb-4">Template</h3>
          ...
          <div className="bg-white rounded-lg border border-neo-border p-6">
            <h3 className="text-sm font-semibold text-neo-ink mb-3">Preview as</h3>
            <div className="flex gap-2 flex-wrap">
              {['Dana Whitfield', 'Marcus Oyelaran', 'Alex Chen'].map((officer) => (
                <button
                  key={officer}
                  className="px-3 py-1 bg-neo-surface-subtle border border-neo-border text-neo-body text-xs rounded hover:bg-neo-navy hover:text-white hover:border-neo-navy transition"
                >
                  {officer}
                </button>
              ))}
          ...
          <div className="space-y-2 text-xs">
            ...
            <div className="p-3 bg-neo-neutral pill bg-neo-surface-subtle text-neo-body-muted rounded-lg">
