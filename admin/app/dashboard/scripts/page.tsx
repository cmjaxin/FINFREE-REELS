  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <h2 className="text-page-title text-neo-ink mb-4">Scripts</h2>
        <div className="flex gap-3">
          <button className="px-4 py-2 text-neo-body-muted hover:text-neo-body transition">
            Generate with AI
          </button>
      ...
      <div className="grid grid-cols-2 gap-6">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="bg-white rounded-lg border border-neo-border p-4 hover:border-neo-ink transition cursor-pointer">
            <div className="flex items-start justify-between mb-3">
              <h3 className="text-card-title text-neo-ink font-semibold">Refi breakeven analysis</h3>
            ...
            <div className="flex gap-1 h-12 mb-4 bg-neo-border rounded overflow-hidden">
              ...
              <div className="flex-1 bg-neo-surface-subtle flex items-center justify-center">
                <span className="font-mono text-xs text-neo-body-muted font-bold">BODY<br/>16s</span>
              </div>
              <div className="flex-1 bg-neo-surface-subtle flex items-center justify-center">
                <span className="font-mono text-xs text-neo-body-muted font-bold">CTA<br/>8s</span>
              </div>
            </div>

            <div className="flex items-center justify-between text-xs">
              <span className="font-mono text-neo-body-muted">6 OFFICERS · 14 VIDEOS</span>
